...
Begin
  ...
  Begin
    ...
    pcb_primitiveparametersIntf := Component;
    for i := 0 to pcb_primitiveparametersIntf.Count() - 1 do
    begin
      parameterByIndex := pcb_primitiveparametersIntf.GetParameterByIndex(i);
      if (parameterByIndex.GetName() = 'Component Kind') and
        (parameterByIndex.GetValue() = 'Standard (No BOM)') then
      begin
        NoBOM := True;
      end;
    end;
